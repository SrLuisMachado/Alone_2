...
public class MenuInferior {
	...
	private void dibujarBarraVitalidad(final Graphics g) {
		...
		DibujoDebug.dibujarRectanguloRelleno(g, areaInventario.x + 35, areaInventario.y + medidaVertical, medidaHorizontal , medidaVertical, rojoClaro);
		DibujoDebug.dibujarRectanguloRelleno(g, areaInventario.x + 35, areaInventario.y + medidaVertical * 2, medidaHorizontal , medidaVertical, rojoOscuro);
		
		g.setColor(Color.white);
		DibujoDebug.dibujarString(g, "VIT", areaInventario.x + 10, areaInventario.y + medidaVertical * 3);
		DibujoDebug.dibujarString(g, "1000", medidaHorizontal + 40, areaInventario.y + medidaVertical * 3);
	}
